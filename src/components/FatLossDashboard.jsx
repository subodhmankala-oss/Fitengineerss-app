...
const FatLossDashboard = ({ setActiveTab, handleLogout }) => {
  ...
  useEffect(() => {
    ...
    const effectiveMeals = {
      breakfast: savedBreakfast !== null ? parseInt(savedBreakfast) : 250,
      lunch:     savedLunch     !== null ? parseInt(savedLunch)     : 400,
  ...
  return (
    <div className="fat-loss-container animate-slide-up">
      ...
      <div className="tracker-section mt-4">
        <h3 className="section-label">Deficit Accountability</h3>
