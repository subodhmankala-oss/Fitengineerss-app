...
const MuscleDashboard = ({ setActiveTab, handleLogout }) => {
  ...
  const completedChecklistItems = (checks.protein ? 1 : 0) + (checks.calories ? 1 : 0) + (checks.workout ? 1 : 0);
  ...
  return (
    <div className="muscle-container animate-slide-up">
        ...
        <div className="hub-layout">
          ...
          <div className="calorie-math-col">
            ...
            <div className="net-status-banner mt-2">
              <span>{caloriesEaten >= calorieBudget ? "💪 Caloric Surplus Reached!" : "🍚 Fuel up more to support hypertrophy"}</span>
            </div>
          </div>
        </div>
        ...
        <div className="meal-tracker-rows">
          <div className="meal-row-card glass-panel">
            <div className="meal-row-left">
              ...
              <div className="meal-details-text">
                <h4>Breakfast</h4>
                <p>Target: ~550 kcal • Logged: {meals.breakfast} kcal</p>
              </div>
            </div>
          ...
          <div className="meal-row-card glass-panel">
            <div className="meal-row-left">
              ...
              <div className="meal-details-text">
                <h4>Lunch</h4>
                <p>Target: ~800 kcal • Logged: {meals.lunch} kcal</p>
              </div>
            </div>
            <div className="meal-row-right">
          ...
          <div className="meal-row-card glass-panel">
            <div className="meal-row-left">
              ...
              <div className="meal-details-text">
                <h4>Dinner</h4>
                <p>Target: ~700 kcal • Logged: {meals.dinner} kcal</p>
              </div>
            </div>
            <div className="meal-row-right">
          ...
          <div className="meal-row-card glass-panel">
            <div className="meal-row-left">
              ...
              <div className="meal-details-text">
                <h4>Snacks</h4>
                <p>Target: ~450 kcal • Logged: {meals.snacks} kcal</p>
              </div>
            </div>
            <div className="meal-row-right">
      ...
      <div className="tracker-section mt-4">
        <div className="checklist-header-wrapper" style={{
          ...
          <h3 className="section-label" style={{ margin: 0 }}>Muscle Hypertrophy Checklist</h3>
        ...
        <div className="checklist-grid">
          <button className={`toggle-card ${checks.protein ? 'active' : ''}`} onClick={() => toggleCheck('protein')}>
            <span className="icon">🍗</span>
            <span className="text">Eat {userProteinTarget}g Protein</span>
          </button>
          <button className={`toggle-card ${checks.calories ? 'active' : ''}`} onClick={() => toggleCheck('calories')}>
            <span className="icon">🍚</span>
            <span className="text">Meet {calorieBudget} kcal Target</span>
          </button>
          <button className={`toggle-card ${checks.workout ? 'active' : ''}`} onClick={() => toggleCheck('workout')}>
            <span className="icon">🏋️‍♂️</span>
            <span className="text">Progressive Overload</span>
          </button>
        </div>
      </div>
