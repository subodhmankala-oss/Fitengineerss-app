...
describe('NextWorkoutBanner', () => {
  ...
  it('suggests the first Gym Beginner program for a client with no logged sessions', async () => {
  ...
  it('writes the last-tab/last-level/last-category and auto-start localStorage keys, then navigates on click', async () => {
    mockLibrary({ gym: { beginner: gymBeginner } });
